...
function ed(tt, te, tr, ti) {
    ...
    console.log('tf',tf);
    console.log('tu',tu);
    console.log('t8(td)',t8(td));
    console.log('td',td);
    console.log('tc',tc)
    var tp = [ta, tf, tu, t8(td) && td, tc].filter(Boolean).join("+");
    console.log('ty_md5(tp)',ty_md5(tp))
    return {
        source: tp,
        // typ() 是md5
        signature: encrypt_b(ty_md5(tp))
    }
}
var tt = 'https://www.zhihu.com/api/v4/comment_v5/questions/616391683/root_comment?order_by=score&limit=20&offset=5_10644646984_0'
var te = undefined
var tr = {
    "zse93": "101_3_3.0",
    "dc0": "ADDSD-j4lRePTsK721fRFrWpxQLGjfijbjo=|1697981461",
    "xZst81": null
}
ti = undefined

console.log(ed(tt,te,tr,ti))