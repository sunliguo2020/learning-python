    ...
    <div class="cle cart_main">
      <div class="flowBox_cart">
        ...
        <div class="flowBox_in">
          ...
          <div class="flowBox">
            <h6><span>商品列表</span><a href="#" class="f16">返回修改购物车</a></h6>
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tbody>
                ...
                <tr align="center" v-for="item in cart_lists">
                  <td bgcolor="#ffffff">
                    <router-link :to="'detail/'+item.goods.id" target="_blank" class="f6">{{item.goods.name}}</router-link>
                  </td>
                  <td bgcolor="#ffffff">￥{{item.goods.market_price}}元</td>
                  <td bgcolor="#ffffff">￥{{item.goods.price}}元</td>
                  <td bgcolor="#ffffff">{{item.goods_num}}</td>
                  <td bgcolor="#ffffff">￥{{item.goods.price*item.goods_num}}元</td>
                </tr>
          ...
          <div class="blank"></div>
          <div class="flowBox">
            <h6><span>收货人信息</span><a href="http://ecshop.numberone.ink:10005/flow.php?step=consignee" class="f16">返回修改收货地址</a></h6>
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tbody>
                <tr>
          ...
          <div class="flowBox">
            ...
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="shippingTable">
              <tbody>
                ...
                <tr>
                  <td bgcolor="#ffffff" align="center"><input name="shipping" type="radio" value="3" supportcod="0" insure="0" checked></td>
                  <td bgcolor="#ffffff"><strong>全场包邮</strong></td>
                </tr>
                <tr>
                  <td bgcolor="#ffffff" align="center"><input name="shipping" type="radio" value="3" supportcod="0" insure="0" disabled></td>
                  <td bgcolor="#ffffff"><strong>顺丰速运</strong></td>
                </tr>
                <tr>
                  <td bgcolor="#ffffff" align="center"><input name="shipping" type="radio" value="4" supportcod="1" insure="0" disabled></td>
          ...
          <div class="flowBox">
            ...
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="paymentTable">
              <tbody>
                ...
                <tr>
                  <td bgcolor="#ffffff"><input type="radio" name="payment" value="1" id="pay_check_value_1" checked="" iscod="0"></td>
                  <td bgcolor="#ffffff"><label class="pay_label" for="pay_check_value_1">支付宝</label></td>
                </tr>

                <tr>
                  <td bgcolor="#ffffff"><input type="radio" name="payment" value="2" id="pay_check_value_2" iscod="0"></td>
                  <td bgcolor="#ffffff"><label class="pay_label" for="pay_check_value_2">微信支付</label></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="flowBox">
            ...
            <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              <tbody>
                <tr>
                  <td valign="top" bgcolor="#f5f5f5"><strong>订单附言:</strong></td>
                  <td bgcolor="#ffffff"><textarea name="postscript" cols="80" rows="3" id="postscript" v-model="memo" style="border:1px solid #ccc;"></textarea></td>
                </tr>
          ...
          <div class="flowBox">
                ...
                <tbody>
                  ...
                  <tr>
                    <td align="right" bgcolor="#f5f5f5" style="color:#666666;">
                      商品总价: <font class="f4_b">￥{{this.allprice}}元</font>
                    </td>
                  </tr>
                  <tr>
                    <td align="right" bgcolor="#ffffff">
                      应付款金额: <font class="f4_b">￥{{this.allprice}}元</font>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div align="center" style="margin:8px auto;">
              <img src="../../static/images/bnt_subOrder.jpg" @click="submit_order">
            </div>
          </div>
...
<script>
  ...
  import { getCart,addOrder } from "@/api/order"
      ...
      getAddressData() {
        getAddress().then((response) => {
          ...
          if (response.status === 200) {
            ...
            this.address = this.address_lists[0].province + this.address_lists[0].city + this.address_lists[0].district + this.address_lists[0].address;
